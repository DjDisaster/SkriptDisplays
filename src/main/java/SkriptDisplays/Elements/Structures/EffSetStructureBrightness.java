...
public class EffSetStructureBrightness extends Effect {

    static {
        Skript.registerEffect(EffSetStructureBrightness.class, "set display brightness of %placedstructure% to %number%");
    }
